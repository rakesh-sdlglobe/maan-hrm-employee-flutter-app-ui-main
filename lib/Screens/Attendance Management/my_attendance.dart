                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            padding: const EdgeInsets.all(4.0),
                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(30.0), color: kMainColor),
                            child: Row(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        'Office',
                                        style: kTextStyle.copyWith(color: isOffice ? kTitleColor : Colors.white),
                                      ),
                                      const SizedBox(
                                        width: 12.0,
                                      ),
                          ...
                          Container(
                            ...
                            child: GestureDetector(
                              onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>const NewAttendenceReport()));
                              },
                              child: CircleAvatar(
                                radius: 80.0,
